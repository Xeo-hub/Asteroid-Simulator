...
void calculate_collisions(vector <space_aos> &space , int obj_1, int obj_2, int num_objects_final) {
    /* Se suman las masas */
...
void calculate_forces(vector <space_aos> &space, int num_objects, int final, int num_objects_final) {
            ...
            for (int j = 0; j < num_objects; j++) {
                ...
                if (i != j) {
                    ...
                    if (0 != space[j].vec_m) {
                        ...
                        if (1 > norma) {
                            calculate_collisions(space, i, j,num_objects_final);
                        } else {
...
int main(int argc, char *argv[]) {
    ...
    for (int i=0; i<num_iterations; i++){
        ...
        calculate_forces(space, num_objects, final, num_objects_final);
        for (int j=0; j<num_objects; j++) {
